...
#include "RecoVertex/PrimaryVertexProducer/interface/DisplacedVertexProducerAlgorithm.h"
...
class DisplacedVertexProducer : public edm::stream::EDProducer<> {
public:
  DisplacedVertexProducer(const edm::ParameterSet&);
