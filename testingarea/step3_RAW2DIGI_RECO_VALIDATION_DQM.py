...
process = cms.Process('RECO',Run3,pixelNtupletFit)
...
process.reconstructionhacked_step = cms.Path(process.reconstruction_pixelTrackingOnly*process.TestVertexFit3D)
...
# Schedule definition
process.schedule = cms.Schedule(process.raw2digi_step,process.reconstructionhacked_step,process.prevalidation_step,process.validation_step,process.dqmoffline_step,process.dqmofflineOnPAT_step,process.RECOSIMoutput_step,process.DQMoutput_step)
